...
if __name__ == '__main__':
	...
	for f in audio_files :
		...
		audio_file_name = args.audio.split('/')[-1][:-4] if '/' in args.audio else args.audio[:-4]
		os.makedirs(f"results/{audio_file_name[:4]}", exist_ok=True)
		...
		for file in files:
			...
			args.outfile = f"results/{audio_file_name[:4]}/{audio_file_name}_{file_name}.mp4"
			args.face = path
			
			print('---------------------------------------')
			print('Input file path : ' , args.face)
			print('Audio file path : ', args.audio)
			print('Output file path : ', args.outfile)
			print('---------------------------------------')
